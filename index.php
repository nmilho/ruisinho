...
<html lang="en">
	...
	<body data-spy="scroll" data-target=".main-nav" id="body">
		...
		<section class="call-2-acction" style="background-image: url(newphotos/adega02.jpeg);">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="c2a">
							<h2>Os melhores vinhos</h2>
			...
			<div class="container-fluid ">
				<div class="row">
					<div class="col-md-12 no-padding ">
						<div class="section-title st-center">
							<h3>Tours</h3>
							<p>Temos os melhores roteiros para si</p>
						</div>

						<div class="grid">
							<figure class="portfolio-item" data-groups='["passeios"]'>
								<img src="newphotos/portfolio/guadiana.jpg" alt=""/>
								<figcaption>
									<h2><span>Passeios</span></h2>
									<p>Passeios temáticos pelo Alentejo e Algarve</p>
							</figure>
							<figure class="portfolio-item" data-groups='["enoturismo"]'>
								<img src="newphotos/portfolio/adega01.jpg" alt=""/>
								<figcaption>
									<h2><span>Eno</span>turismo</h2>
									<p>Visite as melhores adegas e prove os melhores vinhos</p>
								</figcaption>
							</figure>
							<figure class="portfolio-item" data-groups='["profissionais"]'>
								<img src="newphotos/portfolio/olival01.jpg" alt=""/>
								<figcaption>
									<h2>Tours <span>Profissionais</span></h2>
									<p>Segurança e Excelência</p>
								</figcaption>
							</figure>
							<figure class="portfolio-item" data-groups='["aventura"]'>
								<img src="newphotos/portfolio/vinha01.jpg" alt=""/>
								<figcaption>
									<h2><span>Aventura</span></h2>
		...
		<section class="call-2-acction" style="background-image: url(newphotos/vinhabgo.jpg);">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="c2a">
							<h2>O Alentejo mais perto de si</h2>
							<p>Evertitur depravatum illo tamquam novum, possent intus laudatur hinc grate aristoteli per splendido soluta fabulae, ne aristippi cui deleniti nostros illud.</p>
						</div>
					</div>
				</div>
